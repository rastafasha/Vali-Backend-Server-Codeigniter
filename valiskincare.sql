...
-- Tiempo de generación: 30-07-2020 a las 09:18:31
...
INSERT INTO `antiages` (`id`, `title`, `titleesp`, `user_id`, `category_id`, `description`, `descriptionesp`, `price`, `popup`, `button`, `image`, `is_featured`, `is_active`, `created_at`, `textFinanc`, `textFinancEsp`, `is_activeTf`) VALUES
...
INSERT INTO `bodys` (`id`, `title`, `titleesp`, `user_id`, `category_id`, `description`, `descriptionesp`, `price`, `popup`, `button`, `image`, `is_featured`, `is_active`, `created_at`, `textFinanc`, `textFinancEsp`, `is_activeTf`) VALUES
...
INSERT INTO `bridals` (`id`, `title`, `titleesp`, `user_id`, `category_id`, `description`, `descriptionesp`, `price`, `popup`, `button`, `image`, `is_featured`, `is_active`, `created_at`, `textFinanc`, `textFinancEsp`, `is_activeTf`) VALUES
...
INSERT INTO `brightenings` (`id`, `title`, `titleesp`, `user_id`, `category_id`, `description`, `descriptionesp`, `price`, `popup`, `button`, `image`, `is_featured`, `is_active`, `created_at`, `textFinanc`, `textFinancEsp`, `is_activeTf`) VALUES
...
INSERT INTO `calmings` (`id`, `title`, `titleesp`, `user_id`, `category_id`, `description`, `descriptionesp`, `price`, `popup`, `button`, `image`, `is_featured`, `is_active`, `created_at`, `textFinanc`, `textFinancEsp`, `is_activeTf`) VALUES
...
INSERT INTO `clasess` (`id`, `title`, `titleesp`, `user_id`, `category_id`, `description`, `descriptionesp`, `price`, `popup`, `button`, `image`, `is_featured`, `is_active`, `created_at`, `is_activeTf`, `textFinancEsp`, `textFinanc`) VALUES
...
INSERT INTO `fibrofaces` (`id`, `title`, `titleesp`, `user_id`, `category_id`, `description`, `descriptionesp`, `price`, `popup`, `button`, `image`, `is_featured`, `is_active`, `created_at`, `textFinanc`, `textFinancEsp`, `is_activeTf`) VALUES
...
INSERT INTO `hands` (`id`, `title`, `titleesp`, `user_id`, `category_id`, `description`, `descriptionesp`, `price`, `popup`, `button`, `image`, `is_featured`, `is_active`, `created_at`, `is_activeTf`, `textFinanc`, `textFinancEsp`) VALUES
...
INSERT INTO `hypertrophics` (`id`, `title`, `titleesp`, `user_id`, `category_id`, `description`, `descriptionesp`, `price`, `popup`, `button`, `image`, `is_featured`, `is_active`, `created_at`, `textFinanc`, `is_activeTf`, `textFinancEsp`) VALUES
...
INSERT INTO `looks` (`id`, `title`, `titleesp`, `user_id`, `category_id`, `description`, `descriptionesp`, `price`, `popup`, `button`, `image`, `is_featured`, `is_active`, `created_at`, `is_activeTf`, `textFinanc`, `textFinancEsp`) VALUES
...
INSERT INTO `luxurings` (`id`, `title`, `titleesp`, `user_id`, `category_id`, `description`, `descriptionesp`, `price`, `popup`, `button`, `image`, `is_featured`, `is_active`, `created_at`, `textFinanc`, `is_activeTf`, `textFinancEsp`) VALUES
...
INSERT INTO `restoratives` (`id`, `title`, `titleesp`, `user_id`, `category_id`, `description`, `descriptionesp`, `price`, `popup`, `button`, `image`, `is_featured`, `is_active`, `created_at`, `textFinanc`, `is_activeTf`, `textFinancEsp`) VALUES
...
INSERT INTO `specialfs` (`id`, `title`, `titleesp`, `user_id`, `category_id`, `description`, `descriptionesp`, `price`, `popup`, `button`, `image`, `is_featured`, `is_active`, `created_at`, `is_activeTf`, `textFinanc`, `textFinancEsp`) VALUES
...
INSERT INTO `specialts` (`id`, `title`, `titleesp`, `user_id`, `category_id`, `description`, `descriptionesp`, `price`, `popup`, `button`, `image`, `is_featured`, `is_active`, `created_at`, `textFinanc`, `is_activeTf`, `textFinancEsp`) VALUES
(1, 'free Consultation Appointment ', 'Consulta Gratuita', 1, 1, '<p>Let our skin experts help you choose the perfect treatment with your skin concern. Our first consultation is FREE, you will be receive a Complementary Facial.&nbsp;<br><br><i><strong>Let yourself, come, relax and enjoy with us!!</strong></i></p>', '<p>Deje que nuestros expertos lo ayuden a elegir el tratamiento perfecto para su piel. Nuestra primera consulta es GRATUITA, recibirás un facial complementario.&nbsp;</p><p>&nbsp;</p><p><i><strong>Se tu misma, ven, relájate y disfruta con nosotros</strong></i></p>', 'Free', 'modal', 'https://squareup.com/appointments/buyer/widget/zec4v7j1ie9cht/RFSCRQJSQAYNW', '1_FREE-CONSULTATION.jpg', 1, 1, '2018-10-27 04:12:09', '', '', ''),
