...
--
-- Host: localhost:8889
-- Generation Time: Mar 25, 2020 at 02:10 PM
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Malcolm', 'Cordova', 'a1aed1a77c0916c43a4a67afe49af265', 'img2.jpg', 1, '2018-10-27 05:25:13'),
(3, 'adminvali', '14956c52a520d4d4aa19c65cb621e538', 'Vali', 'Spa', 'a1aed1a77c0916c43a4a67afe49af266', 'logo.png', 1, '2019-12-12 00:00:00');
...
CREATE TABLE `waxs` (
  ...
  `is_activeTf` varchar(155) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vali`.`products`  AS  select `vali`.`antiages`.`id` AS `id`,'antiages' AS `type`,`vali`.`antiages`.`title` AS `title`,`vali`.`antiages`.`description` AS `description`,`vali`.`antiages`.`titleesp` AS `titleesp`,`vali`.`antiages`.`descriptionesp` AS `descriptionesp`,`vali`.`antiages`.`price` AS `price`,`vali`.`antiages`.`popup` AS `popup`,`vali`.`antiages`.`button` AS `button`,`vali`.`antiages`.`image` AS `image`,`vali`.`antiages`.`is_featured` AS `is_featured`,`vali`.`antiages`.`is_active` AS `is_active`,`vali`.`antiages`.`created_at` AS `created_at` from `vali`.`antiages` union select `vali`.`bodys`.`id` AS `id`,'bodys' AS `bodys`,`vali`.`bodys`.`title` AS `title`,`vali`.`bodys`.`description` AS `description`,`vali`.`bodys`.`titleesp` AS `titleesp`,`vali`.`bodys`.`descriptionesp` AS `descriptionesp`,`vali`.`bodys`.`price` AS `price`,`vali`.`bodys`.`popup` AS `popup`,`vali`.`bodys`.`button` AS `button`,`vali`.`bodys`.`image` AS `image`,`vali`.`bodys`.`is_featured` AS `is_featured`,`vali`.`bodys`.`is_active` AS `is_active`,`vali`.`bodys`.`created_at` AS `created_at` from `vali`.`bodys` union select `vali`.`bridals`.`id` AS `id`,'bridals' AS `bridals`,`vali`.`bridals`.`title` AS `title`,`vali`.`bridals`.`description` AS `description`,`vali`.`bridals`.`titleesp` AS `titleesp`,`vali`.`bridals`.`descriptionesp` AS `descriptionesp`,`vali`.`bridals`.`price` AS `price`,`vali`.`bridals`.`popup` AS `popup`,`vali`.`bridals`.`button` AS `button`,`vali`.`bridals`.`image` AS `image`,`vali`.`bridals`.`is_featured` AS `is_featured`,`vali`.`bridals`.`is_active` AS `is_active`,`vali`.`bridals`.`created_at` AS `created_at` from `vali`.`bridals` union select `vali`.`brightenings`.`id` AS `id`,'brightenings' AS `brightenings`,`vali`.`brightenings`.`title` AS `title`,`vali`.`brightenings`.`description` AS `description`,`vali`.`brightenings`.`titleesp` AS `titleesp`,`vali`.`brightenings`.`descriptionesp` AS `descriptionesp`,`vali`.`brightenings`.`price` AS `price`,`vali`.`brightenings`.`popup` AS `popup`,`vali`.`brightenings`.`button` AS `button`,`vali`.`brightenings`.`image` AS `image`,`vali`.`brightenings`.`is_featured` AS `is_featured`,`vali`.`brightenings`.`is_active` AS `is_active`,`vali`.`brightenings`.`created_at` AS `created_at` from `vali`.`brightenings` union select `vali`.`calmings`.`id` AS `id`,'calmings' AS `calmings`,`vali`.`calmings`.`title` AS `title`,`vali`.`calmings`.`description` AS `description`,`vali`.`calmings`.`titleesp` AS `titleesp`,`vali`.`calmings`.`descriptionesp` AS `descriptionesp`,`vali`.`calmings`.`price` AS `price`,`vali`.`calmings`.`popup` AS `popup`,`vali`.`calmings`.`button` AS `button`,`vali`.`calmings`.`image` AS `image`,`vali`.`calmings`.`is_featured` AS `is_featured`,`vali`.`calmings`.`is_active` AS `is_active`,`vali`.`calmings`.`created_at` AS `created_at` from `vali`.`calmings` union select `vali`.`clasess`.`id` AS `id`,'clasess' AS `clasess`,`vali`.`clasess`.`title` AS `title`,`vali`.`clasess`.`description` AS `description`,`vali`.`clasess`.`titleesp` AS `titleesp`,`vali`.`clasess`.`descriptionesp` AS `descriptionesp`,`vali`.`clasess`.`price` AS `price`,`vali`.`clasess`.`popup` AS `popup`,`vali`.`clasess`.`button` AS `button`,`vali`.`clasess`.`image` AS `image`,`vali`.`clasess`.`is_featured` AS `is_featured`,`vali`.`clasess`.`is_active` AS `is_active`,`vali`.`clasess`.`created_at` AS `created_at` from `vali`.`clasess` union select `vali`.`fibrofaces`.`id` AS `id`,'fibrofaces' AS `fibrofaces`,`vali`.`fibrofaces`.`title` AS `title`,`vali`.`fibrofaces`.`description` AS `description`,`vali`.`fibrofaces`.`titleesp` AS `titleesp`,`vali`.`fibrofaces`.`descriptionesp` AS `descriptionesp`,`vali`.`fibrofaces`.`price` AS `price`,`vali`.`fibrofaces`.`popup` AS `popup`,`vali`.`fibrofaces`.`button` AS `button`,`vali`.`fibrofaces`.`image` AS `image`,`vali`.`fibrofaces`.`is_featured` AS `is_featured`,`vali`.`fibrofaces`.`is_active` AS `is_active`,`vali`.`fibrofaces`.`created_at` AS `created_at` from `vali`.`fibrofaces` union select `vali`.`hands`.`id` AS `id`,'hands' AS `hands`,`vali`.`hands`.`title` AS `title`,`vali`.`hands`.`description` AS `description`,`vali`.`hands`.`titleesp` AS `titleesp`,`vali`.`hands`.`descriptionesp` AS `descriptionesp`,`vali`.`hands`.`price` AS `price`,`vali`.`hands`.`popup` AS `popup`,`vali`.`hands`.`button` AS `button`,`vali`.`hands`.`image` AS `image`,`vali`.`hands`.`is_featured` AS `is_featured`,`vali`.`hands`.`is_active` AS `is_active`,`vali`.`hands`.`created_at` AS `created_at` from `vali`.`hands` union select `vali`.`hypertrophics`.`id` AS `id`,'hypertrophics' AS `hypertrophics`,`vali`.`hypertrophics`.`title` AS `title`,`vali`.`hypertrophics`.`description` AS `description`,`vali`.`hypertrophics`.`titleesp` AS `titleesp`,`vali`.`hypertrophics`.`descriptionesp` AS `descriptionesp`,`vali`.`hypertrophics`.`price` AS `price`,`vali`.`hypertrophics`.`popup` AS `popup`,`vali`.`hypertrophics`.`button` AS `button`,`vali`.`hypertrophics`.`image` AS `image`,`vali`.`hypertrophics`.`is_featured` AS `is_featured`,`vali`.`hypertrophics`.`is_active` AS `is_active`,`vali`.`hypertrophics`.`created_at` AS `created_at` from `vali`.`hypertrophics` union select `vali`.`looks`.`id` AS `id`,'looks' AS `looks`,`vali`.`looks`.`title` AS `title`,`vali`.`looks`.`description` AS `description`,`vali`.`looks`.`titleesp` AS `titleesp`,`vali`.`looks`.`descriptionesp` AS `descriptionesp`,`vali`.`looks`.`price` AS `price`,`vali`.`looks`.`popup` AS `popup`,`vali`.`looks`.`button` AS `button`,`vali`.`looks`.`image` AS `image`,`vali`.`looks`.`is_featured` AS `is_featured`,`vali`.`looks`.`is_active` AS `is_active`,`vali`.`looks`.`created_at` AS `created_at` from `vali`.`looks` union select `vali`.`luxurings`.`id` AS `id`,'luxurings' AS `luxurings`,`vali`.`luxurings`.`title` AS `title`,`vali`.`luxurings`.`description` AS `description`,`vali`.`luxurings`.`titleesp` AS `titleesp`,`vali`.`luxurings`.`descriptionesp` AS `descriptionesp`,`vali`.`luxurings`.`price` AS `price`,`vali`.`luxurings`.`popup` AS `popup`,`vali`.`luxurings`.`button` AS `button`,`vali`.`luxurings`.`image` AS `image`,`vali`.`luxurings`.`is_featured` AS `is_featured`,`vali`.`luxurings`.`is_active` AS `is_active`,`vali`.`luxurings`.`created_at` AS `created_at` from `vali`.`luxurings` union select `vali`.`permanents`.`id` AS `id`,'permanents' AS `permanents`,`vali`.`permanents`.`title` AS `title`,`vali`.`permanents`.`description` AS `description`,`vali`.`permanents`.`titleesp` AS `titleesp`,`vali`.`permanents`.`descriptionesp` AS `descriptionesp`,`vali`.`permanents`.`price` AS `price`,`vali`.`permanents`.`popup` AS `popup`,`vali`.`permanents`.`button` AS `button`,`vali`.`permanents`.`image` AS `image`,`vali`.`permanents`.`is_featured` AS `is_featured`,`vali`.`permanents`.`is_active` AS `is_active`,`vali`.`permanents`.`created_at` AS `created_at` from `vali`.`permanents` union select `vali`.`restoratives`.`id` AS `id`,'restoratives' AS `restoratives`,`vali`.`restoratives`.`title` AS `title`,`vali`.`restoratives`.`description` AS `description`,`vali`.`restoratives`.`titleesp` AS `titleesp`,`vali`.`restoratives`.`descriptionesp` AS `descriptionesp`,`vali`.`restoratives`.`price` AS `price`,`vali`.`restoratives`.`popup` AS `popup`,`vali`.`restoratives`.`button` AS `button`,`vali`.`restoratives`.`image` AS `image`,`vali`.`restoratives`.`is_featured` AS `is_featured`,`vali`.`restoratives`.`is_active` AS `is_active`,`vali`.`restoratives`.`created_at` AS `created_at` from `vali`.`restoratives` union select `vali`.`sculptings`.`id` AS `id`,'sculptings' AS `sculptings`,`vali`.`sculptings`.`title` AS `title`,`vali`.`sculptings`.`description` AS `description`,`vali`.`sculptings`.`titleesp` AS `titleesp`,`vali`.`sculptings`.`descriptionesp` AS `descriptionesp`,`vali`.`sculptings`.`price` AS `price`,`vali`.`sculptings`.`popup` AS `popup`,`vali`.`sculptings`.`button` AS `button`,`vali`.`sculptings`.`image` AS `image`,`vali`.`sculptings`.`is_featured` AS `is_featured`,`vali`.`sculptings`.`is_active` AS `is_active`,`vali`.`sculptings`.`created_at` AS `created_at` from `vali`.`sculptings` union select `vali`.`specialfs`.`id` AS `id`,'specialfs' AS `specialfs`,`vali`.`specialfs`.`title` AS `title`,`vali`.`specialfs`.`description` AS `description`,`vali`.`specialfs`.`titleesp` AS `titleesp`,`vali`.`specialfs`.`descriptionesp` AS `descriptionesp`,`vali`.`specialfs`.`price` AS `price`,`vali`.`specialfs`.`popup` AS `popup`,`vali`.`specialfs`.`button` AS `button`,`vali`.`specialfs`.`image` AS `image`,`vali`.`specialfs`.`is_featured` AS `is_featured`,`vali`.`specialfs`.`is_active` AS `is_active`,`vali`.`specialfs`.`created_at` AS `created_at` from `vali`.`specialfs` union select `vali`.`specialts`.`id` AS `id`,'specialts' AS `specialts`,`vali`.`specialts`.`title` AS `title`,`vali`.`specialts`.`description` AS `description`,`vali`.`specialts`.`titleesp` AS `titleesp`,`vali`.`specialts`.`descriptionesp` AS `descriptionesp`,`vali`.`specialts`.`price` AS `price`,`vali`.`specialts`.`popup` AS `popup`,`vali`.`specialts`.`button` AS `button`,`vali`.`specialts`.`image` AS `image`,`vali`.`specialts`.`is_featured` AS `is_featured`,`vali`.`specialts`.`is_active` AS `is_active`,`vali`.`specialts`.`created_at` AS `created_at` from `vali`.`specialts` union select `vali`.`waxs`.`id` AS `id`,'waxs' AS `waxs`,`vali`.`waxs`.`title` AS `title`,`vali`.`waxs`.`description` AS `description`,`vali`.`waxs`.`titleesp` AS `titleesp`,`vali`.`waxs`.`descriptionesp` AS `descriptionesp`,`vali`.`waxs`.`price` AS `price`,`vali`.`waxs`.`popup` AS `popup`,`vali`.`waxs`.`button` AS `button`,`vali`.`waxs`.`image` AS `image`,`vali`.`waxs`.`is_featured` AS `is_featured`,`vali`.`waxs`.`is_active` AS `is_active`,`vali`.`waxs`.`created_at` AS `created_at` from `vali`.`waxs` union select `vali`.`wrappings`.`id` AS `id`,'wrappings' AS `wrappings`,`vali`.`wrappings`.`title` AS `title`,`vali`.`wrappings`.`description` AS `description`,`vali`.`wrappings`.`titleesp` AS `titleesp`,`vali`.`wrappings`.`descriptionesp` AS `descriptionesp`,`vali`.`wrappings`.`price` AS `price`,`vali`.`wrappings`.`popup` AS `popup`,`vali`.`wrappings`.`button` AS `button`,`vali`.`wrappings`.`image` AS `image`,`vali`.`wrappings`.`is_featured` AS `is_featured`,`vali`.`wrappings`.`is_active` AS `is_active`,`vali`.`wrappings`.`created_at` AS `created_at` from `vali`.`wrappings` ;
